...
int main(int argc, char** argv)
{
	...
	auto mw_instance = restore::create_middleware_instance(mw_config,
		restore::task_metadata{
			.compound_types = jopp::json_buffer{restore::wrap_in_message(restore::get_compound_types())},
			.state_descriptor = jopp::json_buffer{restore::wrap_in_message(restore::get_state_descriptor())},
